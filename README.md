...
截至 2026-09-21，济宁相关 **615 条人物身份记录、893 段任职记录、201 个关联来源**。同名待核记录暂时分开，所以记录数不等于独立自然人数，也不是现任官员总数。
...
本轮新增 16 条身份记录、73 段履历，并复核 10 个既有档案。胡国梁跨部门转任疑点已用同一正式任免文件解决；2025 年公安改革资料保留为历史事实。详见 [本轮复核与更新](docs/NETWORK_REVIEW_2026-09-21.md)。
...
- [来源全量盘点](docs/SOURCE_INVENTORY.md)：490 个来源编号、459 个网址；不同链接仍可能同源转载。
