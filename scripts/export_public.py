...
from status_events import STATUS_EVENT_FIELDS, validate_status_events
...
SCHEMAS={
 ...
 'status_events':fields(STATUS_EVENT_FIELDS),
...
PUBLIC_GUIDES.add('personnel-status-labels')
